...
url = 'https://www.datart.cz/televize-lg-43ur9100.html'
...
def fetch_price(url, headers):
    try:
        ...
        datart_soup, _ = parse_response(response_text, response_url)

        # Find the price element
        price_wrap = datart_soup.find(name="div", class_="price-wrap")
